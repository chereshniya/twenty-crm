...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: '98b0d181-6a83-4f90-8d70-2d8f3bb91e8e', fieldMetadataUniversalIdentifier: LAND_PLOT_COVER_FIELD_ID, position: 1, isVisible: true, size: 180 },
    { universalIdentifier: 'e5ce2855-143b-44d2-81fe-ff9a0986ec3e', fieldMetadataUniversalIdentifier: LAND_PLOT_PHOTOS_FIELD_ID, position: 2, isVisible: true, size: 220 },
